...
NO tabela2[MAX], NO tabela3[MAX], int X, int Y)
{
    ...
    bool a = excluirIndice2(tabela2,X);
    bool b = inserirIndice2(tabela2,Y,end);

    bool c = excluirIndice1(tabela1,X);
    bool d = inserirIndice1(tabela1,Y,end);

    bool e = excluirIndice2(tabela3,X);
    bool f = inserirIndice2(tabela3, Y,end);
